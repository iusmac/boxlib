...
Option             | Description
------------------ | -----------
`type=`            | <sup id="list-options-type"><sub>[#][list-options-type]</sub></sup> The type of the list box.<br>Possible values: `build`, `check`, `radio`, `tree`.<br>Defaults to: `check`.
...
`depth=`           | <sup id="list_entry-options-depth"><sub>[#][list_entry-options-depth]</sub></sup> The depth of the entry in the tree list. The entry [`title`][list_entry-options-title] is not displayed. After selecting an entry (only one can be selected like in the radio list), the entry [`title`][list_entry-options-title] will be the output.<br>Defaults to `0`.
